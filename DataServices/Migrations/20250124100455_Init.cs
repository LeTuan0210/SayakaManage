        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    areaAlias = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    menuAliasName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    menuDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    menuPrice = table.Column<int>(type: "int", nullable: false),
                    menuImages = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    promotionAlias = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    imageBannerLink = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    promotionContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    createDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    promotionViewCount = table.Column<int>(type: "int", nullable: false),
                    promotionLikeCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    restaurantAliasName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    restaurantAreaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    restaurantCity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    restaurantAvatarLink = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
