...
namespace DataServices.Migrations
{
    ...
    [Migration("20250201084118_AddZaloToken")]
    partial class AddZaloToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModels.Entities.MemberFavouriteRestaurant", b =>
                {
                    b.Property<Guid>("restaurantInfoId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("memberInfoId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("restaurantInfoId", "memberInfoId");

                    b.HasIndex("memberInfoId");

                    b.ToTable("MemberFavouriteRestaurants");
                });
            ...
            modelBuilder.Entity("DataModels.Entities.MemberFavouriteRestaurant", b =>
                {
                    b.HasOne("DataModels.Entities.MemberInfo", "memberInfo")
                        .WithMany("favouriteRestaurant")
                        .HasForeignKey("memberInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataModels.Entities.RestaurantInfo", "restaurantInfo")
                        .WithMany("favouriteMember")
            ...
            modelBuilder.Entity("DataModels.Entities.MemberInfo", b =>
                {
                    b.Navigation("favouriteRestaurant");
                });

            modelBuilder.Entity("DataModels.Entities.RestaurantInfo", b =>
                {
                    b.Navigation("favouriteMember");
                });
